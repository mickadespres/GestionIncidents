                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    $res = $req->fetchALL();?>
                                        ...
                                        <a href="?delete=<?= $ticket['id_ticket']; ?>&<?= csrf(); ?>" onclick="return confirm('Voulez-vous confirmer la résolution du ticket ?');" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>

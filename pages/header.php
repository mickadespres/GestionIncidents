        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../pages/cible.php" style="color:#000033;">Gestion incidents<?php include '../lib/session.php'; echo flash();?></a>
                </div>
                <!-- /.navbar-header -->
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <!-- /.dropdown -->
                    <li class="dropdown">
                        <a style="color:#000033;" class="dropdown-toggle" data-toggle="dropdown" href="#">

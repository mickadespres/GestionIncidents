...
<html lang="fr">
    ...
    <body>
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user" style="color:#000033;">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="color:#000033;"><i class="fa fa-server" style="font-size:36px"></i>  Liste des incidents</h1><?= flash();?>
                </div>
                <!-- /.col-lg-12 -->
